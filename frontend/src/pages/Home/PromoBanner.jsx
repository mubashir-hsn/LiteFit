   ...
   return (
      <>
         <section className='section__container banner__container'>
            <div className='banner__card' data-aos='zoom-in-up'>
         ...
         <section className='section__container' id='parallexbox' data-aos='fade-up'>
            <div className='effect h-full w-full content-center py-10 backdrop-blur-sm'>
               <div data-aos='fade-right' className="effect2 py-20 px-5 w-full md:w-[90%] mx-auto flex flex-col items-center justify-center rounded-3xl text-black bg-cover bg-no-repeat bg-center ">
                  ...
                  <div className="flex flex-col md:block gap-2 justify-center items-center md:join mt-5 outline-none">
                     <input className=" w-auto md:w-[27rem] p-2 text-sm md:text-lg md:p-4 focus:outline-none focus:border-none outline-none rounded-md md:rounded-none md:join-item" required placeholder="Enter your email" />
